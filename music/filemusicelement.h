...
class FileMusicElement : public AbstractMusicElement {
        Q_OBJECT
    public:
        explicit FileMusicElement(QString startResource, QString loopResource, QObject* parent = nullptr);
        explicit FileMusicElement(QUrl startUrl, QUrl loopUrl, QObject* parent = nullptr);
        ~FileMusicElement();
